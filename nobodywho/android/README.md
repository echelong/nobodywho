...
proprietary Adreno Vulkan exclusion avoids observed shader crashes; Adreno
can use OpenCL, and Turnip Vulkan remains eligible. Vision/audio projection stays on CPU because
