...
- **Decision router:** Added one shared decision policy installer for all six coding clients and a data-only Codex MCP bridge (`decision_ask`, `decision_prune_text`) that leaves shell approvals unchanged.
